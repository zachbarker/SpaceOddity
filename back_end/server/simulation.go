...
const PLAY_SPD_PER_TICK = PLAY_SPD_PER_SEC / (1000 / match.TICK_RATE) // player speed in pixels/ticks

// asteroid speed in pixels/second, also corresponds 2 phaser3 engine vel
const AST_SPD_PER_SEC = 50
const AST_SPD_PER_TICK = AST_SPD_PER_SEC / (1000 / match.TICK_RATE) // asteroid speed in pixels/ticks

// bullet speed in pixels/second as above
const BLT_SPD_PER_SEC = 400
const BLT_SPD_PER_TICK = BLT_SPD_PER_SEC / (1000 / match.TICK_RATE) // bullet speed in pixels/ticks
